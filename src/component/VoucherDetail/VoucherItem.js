...
const vouchers = [
  {
    ...
    image: require('../../assets/VoucherImage.png')
  },
  {
    id: '02',
  ...
  },
  {
    ...
    image: require('../../assets/FreeshipImage.png')
  },
  {
    id: '04',
      ...
      {vouchers.map((voucher) => (
        ...
        >
          ...
          <TouchableOpacity
            ...
            <Image source={require('../../assets/VectorPlus.png')} style={{ alignSelf: 'center', justifyContent: 'flex-end' }} />
            <Modal
              ...
              onPressOut={() => {setModalVoucher(!modalVoucher);}}
            >
              <View style={{
                height: '10%',
                ...
                <TouchableOpacity style={{top: 8}} onPress={() => setModalVoucher(false)}>
                  <ApDungButton />
                </TouchableOpacity>
              </View>
            </Modal>
