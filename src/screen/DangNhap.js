...
const DangNhap = () => {
    ...
    return (
        <View style={styles.container}>
            <Image source={require('../assets/Nền1.png')} style={styles.background1} />
            <Image source={require('../assets/Nền2.png')} style={styles.background2} />
            <View style={styles.page}>
                <View style={styles.logo}>
                    <Image source={require('../assets/Logo1.png')} style={{width: '80%', height: '50%'}} />
                </View>
